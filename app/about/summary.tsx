...
export default function Summary() {
  return (
    <CardBox>
      <CardContent>
        {/* <Typography className={styles.dropcap}>{`Hello, my name is Julie. I am a Web Developer from Texas. My hobbies are Linguistics, drawing, and collecting rocks.`}</Typography> */}
